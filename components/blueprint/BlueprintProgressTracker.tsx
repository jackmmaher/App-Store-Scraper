...
const SECTION_STAGES: Record<BlueprintSection, Stage[]> = {
  ...
  identity: [
    { label: 'Analyzing brand direction...', duration: 3 },
    { label: 'Generating name options...', duration: 4 },
    { label: 'Checking naming conventions...', duration: 3 },
    { label: 'Designing icon specifications...', duration: 5 },
    { label: 'Defining visual identity...', duration: 4 },
    { label: 'Creating icon size requirements...', duration: 3 },
    { label: 'Finalizing identity document...', duration: 4 },
  ],
  design_system: [
    { label: 'Establishing color palette...', duration: 4 },
    { label: 'Defining typography scale...', duration: 4 },
    { label: 'Creating spacing system...', duration: 3 },
    { label: 'Specifying borders and shadows...', duration: 3 },
    { label: 'Designing component styles...', duration: 5 },
    { label: 'Adding accessibility guidelines...', duration: 4 },
    { label: 'Generating SwiftUI tokens...', duration: 4 },
  ],
  wireframes: [
  ...
  tech_stack: [
    ...
    { label: 'Evaluating native services...', duration: 4 },
    { label: 'Mapping hardware APIs...', duration: 5 },
    { label: 'Reviewing technical compatibility...', duration: 3 },
    { label: 'Finalizing recommendations...', duration: 4 },
  ],
  xcode_setup: [
    { label: 'Configuring bundle ID...', duration: 3 },
    { label: 'Defining project structure...', duration: 4 },
    { label: 'Setting up Info.plist...', duration: 4 },
    { label: 'Configuring entitlements...', duration: 4 },
    { label: 'Setting up code signing...', duration: 3 },
    { label: 'Preparing App Store Connect...', duration: 4 },
    { label: 'Creating submission checklist...', duration: 3 },
  ],
  prd: [
  ...
  aso: [
    { label: 'Crafting app title and subtitle...', duration: 3 },
    { label: 'Researching keywords...', duration: 4 },
    { label: 'Writing app description...', duration: 5 },
    { label: 'Planning screenshot strategy...', duration: 4 },
    { label: 'Defining preview video scenes...', duration: 3 },
    { label: 'Setting pricing strategy...', duration: 3 },
    { label: 'Finalizing ASO document...', duration: 4 },
  ],
  manifest: [
